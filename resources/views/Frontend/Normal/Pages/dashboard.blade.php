...
@section('dynamic-content')
      ...
      <div class="dashboard-main-body">
        <div
          class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24"
        >
          <div class="">
                ...
                <div class="col-xxl-4 col-sm-6">
                  <div class="card shadow-1 radius-8 gradient-bg-end-1 h-100">
                    <div class="card-body p-20">
                      <div
                        class="d-flex flex-wrap align-items-center gap-3 mb-16"
                      >
                        <div
                          class="w-44-px h-44-px bg-warning-600 rounded-circle d-flex justify-content-center align-items-center"
                        >
                          <img
                            src="{{asset('assets')}}/images/icons/dashboard-icon1.png"
                            alt="Icon"
                          />
                        </div>
                  ...
                  <div class="card shadow-1 radius-8 gradient-bg-end-2 h-100">
                    <div class="card-body p-20">
                      ...
                      >
                        ...
                        >
                          <img
                            src="{{asset('assets')}}/images/icons/dashboard-icon2.png"
                            alt="Icon"
                          />
                        </div>
                        <p class="fw-medium text-primary-light mb-1">
                  ...
                  <div class="card shadow-1 radius-8 gradient-bg-end-3 h-100">
                    <div class="card-body p-20">
                      ...
                      >
                        ...
                        >
                          <img
                            src="{{asset('assets')}}/images/icons/dashboard-icon3.png"
                            alt="Icon"
                          />
                        </div>
                        <p class="fw-medium text-primary-light mb-1">
                  ...
                  <div class="card shadow-1 radius-8 gradient-bg-end-4 h-100">
                    <div class="card-body p-20">
                      ...
                      >
                        ...
                        >
                          <img
                            src="{{asset('assets')}}/images/icons/dashboard-icon4.png"
                            alt="Icon"
                          />
                        </div>
                        <p class="fw-medium text-primary-light mb-1">
                  ...
                  <div class="card shadow-1 radius-8 gradient-bg-end-5 h-100">
                    <div class="card-body p-20">
                      ...
                      >
                        ...
                        >
                          <img
                            src="{{asset('assets')}}/images/icons/dashboard-icon5.png"
                            alt="Icon"
                          />
                        </div>
                        <p class="fw-medium text-primary-light mb-1">
                  ...
                  <div class="card shadow-1 radius-8 gradient-bg-end-6 h-100">
                    <div class="card-body p-20">
                      ...
                      >
                        ...
                        >
                          <img
                            src="{{asset('assets')}}/images/icons/dashboard-icon6.png"
                            alt="Icon"
                          />
                        </div>
                        <p class="fw-medium text-primary-light mb-1">
                ...
                <div class="card-body p-0">
                  ...
                  <div class="p-20">
                    <div class="d-flex gap-6">
                      <div
                        class="h-44-px bg-primary-600 rounded"
                        style="width: 87%"
                      ></div>
                      <div
                        class="h-44-px bg-warning-600 rounded"
                        style="width: 40%"
                      ></div>
                      <div
                        class="h-44-px bg-purple-600 rounded"
                        style="width: 20%"
                      ></div>
                      <div
                        class="h-44-px bg-success-600 rounded"
                        style="width: 20%"
                      ></div>
                    </div>
                    <div class="mt-32 d-flex flex-column gap-24">
                      ...
                      >
                        <div class="d-flex align-items-center gap-2">
                          <span
                            class="w-12-px h-12-px radius-2 bg-warning-600"
                          ></span>
                      ...
                      >
                        <div class="d-flex align-items-center gap-2">
                          <span
                            class="w-12-px h-12-px radius-2 bg-purple-600"
                          ></span>
                      ...
                      >
                        <div class="d-flex align-items-center gap-2">
                          <span
                            class="w-12-px h-12-px radius-2 bg-success-600"
                          ></span>
                          ...
                          <div class="p-20">
                            ...
                            >
                              <li class="d-flex align-items-center gap-8">
                                <span
                                  class="w-12-px h-12-px radius-2 rotate-45-deg bg-primary-600"
                                ></span>
                                <span
                                  class="text-secondary-light text-sm fw-semibold"
                                >
                                  Total Fee:
                              ...
                              <li class="d-flex align-items-center gap-8">
                                <span
                                  class="w-12-px h-12-px radius-2 rotate-45-deg bg-warning-600"
                                ></span>
                                <span
                                  class="text-secondary-light text-sm font-semibold"
                                >
                                  Collected Fee:
                                  <span class="text-primary-light fw-bold">
                                    $300</span
                            ...
                            <div class="dropdown">
                              ...
                              >
                                <iconify-icon
                                  ...
                                  class="icon text-secondary-light"
                                ></iconify-icon>
                              </button>
                              <ul
                                class="dropdown-menu p-12 border bg-base shadow"
                              >
                                <li>
                                  <button
                                    type="button"
                                  ...
                                  >
                                    <iconify-icon
                                      icon="hugeicons:view"
                                      class="icon text-lg line-height-1"
                                    ></iconify-icon>
                                    View
                                  </button>
                                </li>
                          ...
                          <div class="ps-20 pt-20 pb-20">
                            ...
                            >
                              <div class="d-flex align-items-start gap-16">
                                <img
                                  src="{{asset('assets')}}/images/thumbs/notice-board-img1.png"
                                  alt="Thumbnail"
                                ...
                                <div class="">
                                  ...
                                  <span
                                    class="text-secondary-light text-sm mb-0 mt-4"
                                    >25 Jan 2024</span
                                  >
                                </div>
                              </div>
                              <div class="d-flex align-items-start gap-16">
                                <img
                                  src="{{asset('assets')}}/images/thumbs/notice-board-img2.png"
                                  alt="Thumbnail"
                                  class="w-40-px h-40-px rounded-circle object-fit-cover flex-shrink-0"
                                />
                                <div class="">
                              ...
                              <div class="d-flex align-items-start gap-16">
                                <img
                                  src="{{asset('assets')}}/images/thumbs/notice-board-img3.png"
                                  alt="Thumbnail"
                                  class="w-40-px h-40-px rounded-circle object-fit-cover flex-shrink-0"
                                />
                                <div class="">
                          ...
                          <div class="ps-20 pt-20 pb-20">
                            ...
                            >
                              ...
                              >
                                <div class="d-flex align-items-start gap-16">
                                  <img
                                    src="{{asset('assets')}}/images/thumbs/leave-request-img1.png"
                                    alt="Thumbnail"
                                    class="w-40-px h-40-px rounded-circle object-fit-cover flex-shrink-0"
                                  />
                                  <div class="">
                                    ...
                                    <span
                                      class="text-secondary-light text-sm mb-0"
                                      >English Teacher</span
                                    >
                                  </div>
                                </div>
                                <div class="text-end">
                                  <span
                                    class="d-block fw-bold text-primary-light"
                                    >3 Days</span
                                  >
                                  <p class="text-secondary-light text-sm mb-0">
                                    Apply on: 10 April
                              ...
                              >
                                <div class="d-flex align-items-start gap-16">
                                  <img
                                    src="{{asset('assets')}}/images/thumbs/leave-request-img2.png"
                                    alt="Thumbnail"
                                    class="w-40-px h-40-px rounded-circle object-fit-cover flex-shrink-0"
                                  />
                                  <div class="">
                              ...
                              >
                                <div class="d-flex align-items-start gap-16">
                                  <img
                                    src="{{asset('assets')}}/images/thumbs/leave-request-img3.png"
                                    alt="Thumbnail"
                                    class="w-40-px h-40-px rounded-circle object-fit-cover flex-shrink-0"
                                  />
                                  <div class="">
                              ...
                              >
                                <div class="d-flex align-items-start gap-16">
                                  <img
                                    src="{{asset('assets')}}/images/thumbs/leave-request-img4.png"
                                    alt="Thumbnail"
                                    class="w-40-px h-40-px rounded-circle object-fit-cover flex-shrink-0"
                                  />
                                  <div class="">
                              ...
                              >
                                <div class="d-flex align-items-start gap-16">
                                  <img
                                    src="{{asset('assets')}}/images/thumbs/leave-request-img5.png"
                                    alt="Thumbnail"
                                    class="w-40-px h-40-px rounded-circle object-fit-cover flex-shrink-0"
                                  />
                                  <div class="">
                ...
                <div class="col-xxl-4">
                  <div class="card h-100">
                    <div class="card-body p-0">
                      ...
                      <div class="p-20">
                        <div class="calendar">
                          <div class="calendar__header">
                            ...
                            <p
                              class="display text-md text-secondary-light fw-semibold mb-0"
                            >
                              ""
                            </p>
                      ...
                      <div
                        class="ps-20 pt-20 pb-20 border-top border-neutral-200"
                      >
                        ...
                        >
                          ...
                          >
                            <div
                              class="ps-10 border-start-width-3-px border-purple-600"
                            >
                              <div class="d-flex align-items-end gap-6">
                                ...
                                <span
                                  class="text-xs text-secondary-light line-height-1 mb-2"
                                  >AM</span
                                >
                              </div>
                              <p class="text-secondary-light mt-4 mb-2 text-sm">
                            ...
                            <div>
                              <a
                                href="javascript:void(0)"
                                class="py-6 px-16 radius-4 bg-neutral-100 text-secondary-light fw-semibold bg-hover-primary-600 hover-text-white"
                                >View</a
                              >
                            </div>
                          </div>
                          ...
                          >
                            <div
                              class="ps-10 border-start-width-3-px border-warning-600"
                            >
                              <div class="d-flex align-items-end gap-6">
                                <h6 class="text-lg fw-normal mb-0">
                                  11:15 - 12:00
                          ...
                          >
                            <div
                              class="ps-10 border-start-width-3-px border-blue-600"
                            >
                              <div class="d-flex align-items-end gap-6">
                                <h6 class="text-lg fw-normal mb-0">
                                  02:00 - 03:00
                          ...
                          >
                            <div
                              class="ps-10 border-start-width-3-px border-success-600"
                            >
                              <div class="d-flex align-items-end gap-6">
                                <h6 class="text-lg fw-normal mb-0">
                                  04:15 - 05:00
                          ...
                          >
                            <div
                              class="ps-10 border-start-width-3-px border-primary-600"
                            >
                              <div class="d-flex align-items-end gap-6">
                                <h6 class="text-lg fw-normal mb-0">
                                  01:15 - 02:00
                  ...
                  <div class="p-20">
                    <div>
                      ...
                      >
                        ...
                        >
                          <img
                            src="{{asset('assets')}}/images/icons/radial-bg2.png"
                            alt="Image"
                            class="position-absolute top-0 start-0 z-n1 w-100 h-100 object-fit-cover"
                          />
                        ...
                        >
                          <img
                            src="{{asset('assets')}}/images/icons/radial-bg3.png"
                            alt="Image"
                            class="position-absolute top-0 start-0 z-n1 w-100 h-100 object-fit-cover"
                          />
                      ...
                      <div
                        class="d-flex align-items-center flex-wrap gap-24 justify-content-evenly"
                      >
                        <div class="d-flex flex-column align-items-start">
                          <div class="d-flex align-items-center gap-2">
                            <span
                              class="w-12-px h-12-px rounded-pill bg-success-600"
                            ></span>
                          ...
                          <h6
                            class="text-primary-light fw-semibold mb-0 mt-4 text-lg"
                          >
                            750
                          </h6>
                        </div>
                        <div class="d-flex flex-column align-items-start">
                          <div class="d-flex align-items-center gap-2">
                            <span
                              class="w-12-px h-12-px rounded-pill bg-warning-600"
                            ></span>
                            <span class="text-secondary-light text-sm fw-normal"
                              >Teacher</span
                            >
                        ...
                        <div class="d-flex flex-column align-items-start">
                          <div class="d-flex align-items-center gap-2">
                            <span
                              class="w-12-px h-12-px rounded-pill bg-blue-600"
                            ></span>
                            <span class="text-secondary-light text-sm fw-normal"
                              >Staffs
                            </span>
                  ...
                  <div class="ps-20 pt-20 pb-20">
                    ...
                    >
                      ...
                      >
                        <div class="d-flex align-items-start gap-16">
                          <img
                            src="{{asset('assets')}}/images/thumbs/top-teacher-img1.png"
                            alt="Thumbnail"
                            class="w-40-px h-40-px rounded-circle object-fit-cover flex-shrink-0"
                          />
                          <div class="">
                        ...
                        <div class="text-end">
                          <span class="d-block fw-semibold text-primary-light"
                            >Mathematics</span
                          >
                        </div>
                      </div>
                      ...
                      >
                        <div class="d-flex align-items-start gap-16">
                          <img
                            src="{{asset('assets')}}/images/thumbs/top-teacher-img2.png"
                            alt="Thumbnail"
                            class="w-40-px h-40-px rounded-circle object-fit-cover flex-shrink-0"
                          />
                          <div class="">
                      ...
                      >
                        <div class="d-flex align-items-start gap-16">
                          <img
                            src="{{asset('assets')}}/images/thumbs/top-teacher-img3.png"
                            alt="Thumbnail"
                            class="w-40-px h-40-px rounded-circle object-fit-cover flex-shrink-0"
                          />
                          <div class="">
                      ...
                      >
                        <div class="d-flex align-items-start gap-16">
                          <img
                            src="{{asset('assets')}}/images/thumbs/top-teacher-img4.png"
                            alt="Thumbnail"
                            class="w-40-px h-40-px rounded-circle object-fit-cover flex-shrink-0"
                          />
                          <div class="">
                      ...
                      >
                        <div class="d-flex align-items-start gap-16">
                          <img
                            src="{{asset('assets')}}/images/thumbs/top-teacher-img5.png"
                            alt="Thumbnail"
                            class="w-40-px h-40-px rounded-circle object-fit-cover flex-shrink-0"
                          />
                          <div class="">
                ...
                <div class="card-body p-0">
                  ...
                  <div class="p-20">
                    <div class="position-relative text-center">
                      <div
                        id="newAdmissions"
                        class="y-value-left apexcharts-tooltip-z-none"
                      ></div>
                      <div
                      ...
                      >
                        ...
                        <span class="text-secondary-light"
                          >Total Admissions</span
                        >
                      </div>
                    </div>
                    <ul
                      class="d-flex flex-wrap align-items-center justify-content-center mt-48 gap-24"
                    >
                      <li class="d-flex align-items-center gap-2">
                        <span
                          class="w-12-px h-12-px radius-2 bg-success-600 rotate-45-deg"
                        ></span>
                        <div class="">
                      ...
                      <li class="d-flex align-items-center gap-2">
                        <span
                          class="w-12-px h-12-px radius-2 bg-blue-600 rotate-45-deg"
                        ></span>
                        <div class="">
                          <span class="text-secondary-light fw-medium">
                            Math:
                      ...
                      <li class="d-flex align-items-center gap-2">
                        <span
                          class="w-12-px h-12-px radius-2 bg-warning-600 rotate-45-deg"
                        ></span>
                        <div class="">
                          <span class="text-secondary-light fw-medium">
                            Biology:
                      ...
                      <li class="d-flex align-items-center gap-2">
                        <span
                          class="w-12-px h-12-px radius-2 bg-primary-600 rotate-45-deg"
                        ></span>
                        <div class="">
                          <span class="text-secondary-light fw-medium">
                            Physics:
                  ...
                  <div class="d-flex flex-column gap-28">
                    ...
                    >
                      <div class="d-flex align-items-center gap-12">
                        ...
                        >
                          <img
                            src="{{asset('assets')}}/images/thumbs/avatar-img1.png"
                      ...
                      <div class="d-flex align-items-center gap-8">
                        ...
                        <span
                          class="text-primary-light text-sm d-block text-end"
                        >
                          <svg
                            class="radial-progress w-44-px"
                            data-percentage="20"
                            viewBox="0 0 80 80"
                          >
                            <circle
                              class="incomplete stroke-8-px opacity-02 stroke-blue"
                              cx="40"
                              cy="40"
                              r="35"
                            ></circle>
                            <circle
                              class="complete stroke-8-px stroke-blue"
                              cx="40"
                              cy="40"
                              r="35"
                            ></circle>
                            <text
                              class="percentage fill-black"
                              x="50%"
                              y="57%"
                    ...
                    >
                      <div class="d-flex align-items-center gap-12">
                        ...
                        >
                          <img
                            src="{{asset('assets')}}/images/thumbs/avatar-img2.png"
                            class="w-44-px h-44-px object-fit-cover rounded-circle"
                            alt="Icon"
                          />
                        </span>
                      ...
                      <div class="d-flex align-items-center gap-8">
                        ...
                        >
                          ...
                          >
                            <circle
                              class="incomplete stroke-8-px opacity-02 stroke-red"
                              cx="40"
                              cy="40"
                              r="35"
                            ></circle>
                            <circle
                              class="complete stroke-8-px stroke-red"
                              cx="40"
                              cy="40"
                              r="35"
                            ></circle>
                    ...
                    >
                      ...
                      <div class="d-flex align-items-center gap-8">
                        ...
                        >
                          ...
                          >
                            <circle
                              class="incomplete stroke-8-px opacity-02 stroke-warning"
                              cx="40"
                              cy="40"
                              r="35"
                            ></circle>
                            <circle
                              class="complete stroke-8-px stroke-warning"
                              cx="40"
                              cy="40"
                              r="35"
                            ></circle>
                    ...
                    >
                      <div class="d-flex align-items-center gap-12">
                        ...
                        >
                          <img
                            src="{{asset('assets')}}/images/thumbs/avatar-img4.png"
                            class="w-44-px h-44-px object-fit-cover rounded-circle"
                            alt="Icon"
                          />
                        </span>
                      ...
                      <div class="d-flex align-items-center gap-8">
                        ...
                        >
                          ...
                          >
                            <circle
                              class="incomplete stroke-8-px opacity-02 stroke-green"
                              cx="40"
                              cy="40"
                              r="35"
                            ></circle>
                            <circle
                              class="complete stroke-8-px stroke-green"
                              cx="40"
                              cy="40"
                              r="35"
                            ></circle>
                    ...
                    >
                      <div class="d-flex align-items-center gap-12">
                        ...
                        >
                          <img
                            src="{{asset('assets')}}/images/thumbs/avatar-img5.png"
                            class="w-44-px h-44-px object-fit-cover rounded-circle"
                            alt="Icon"
                          />
                        </span>
