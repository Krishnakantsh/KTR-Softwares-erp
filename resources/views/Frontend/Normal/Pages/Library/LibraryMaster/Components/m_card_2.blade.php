                ...
                <div class="premium-input-box match-highlight-zone">
                    ...
                    <div class="inner-addon">
                        ...
                        <select name="active_member_selector" id="activeMemberSelector"
                            ...
                            <option value="">Search by Keyword (e.g. Amit, STU-9021...)</option>
                            <option value="1" data-name="Amit Mishra" data-roll="12" data-class="Class 10-A"
                                data-adm="STU-9021" data-card="LMEM-STU-2026-0001" data-barcode="978026101"
                                data-expiry="2027-06-16">Amit Mishra (STU-9021) - Active</option>
                            <option value="2" data-name="Priya Sharma" data-roll="05" data-class="Class 12-B"
                                data-adm="STU-8842" data-card="LMEM-STU-2026-0042" data-barcode="978026142"
                                data-expiry="2027-04-10">Priya Sharma (STU-8842) - Active</option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <div class="shadow-1 radius-12 bg-base overflow-hidden premium-generator-card p-24 sticky-top-offset">
            <div
                ...
                <span class="text-xs fw-bold text-uppercase tracking-wider text-muted"><i class="ri-eye-line me-1"></i>
                    Live Card Rendering Canvas</span>
                ...
                <div id="physicalCardCanvas" class="library-pvc-card-frame dynamic-card-bg vertical-card-layout">
                    ...
                    <div id="cardHeaderContainer" class="card-pvc-header">
                        ...
                        <div class="header-text-block text-end">
                            <h5 id="canvasHeaderTitle" class="card-institution-title">EXCELLENCE PUBLIC SCHOOL</h5>
                            <p id="canvasHeaderSubtitle" class="card-institution-subtitle">Digital Central Library Pass
                            </p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="signature-render-zone text-center">
                            <div class="admin-sig-line"></div>
                            <small class="text-xxs text-muted tracking-wider text-uppercase d-block mt-4">Authorized
                                Signature</small>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-24 pt-16 border-top d-flex gap-3 justify-content-end">
                ...
                <button type="button" id="dispatchPrintQueue"
                    class="btn btn-premium-action-primary py-8 px-20 text-xs" onclick="window.print();">
        ...
        <div class="shadow-1 radius-12 bg-base overflow-hidden premium-generator-card">
            ...
            <div class="card-body p-24">
                ...
                <div class="row gy-4 mb-24">
                    ...
                    <div class="col-xl-6 col-12">
                        <div class="premium-input-box">
                            <label
                                ...
                                Graphic Upload / Branding Logo</label>
                            <div class="inner-addon">
                                <input type="file" id="cfgHeaderLogoUpload" class="form-control" accept="image/*"
                                    style="font-size: 0.8rem; padding: 6px;">
                            </div>
                            <small class="text-muted text-xxs d-block mt-4">Transparent PNG file setup recommended
                                (Replaces fallback book icon)</small>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-6 col-12">
                        <div class="premium-input-box">
                            ...
                            <small class="text-muted text-xxs d-block mt-4">Low-opacity logo mapping node to handle
                                overlay constraints</small>
                        </div>
                    </div>

                    <div class="col-xl-12 col-12">
                        <div class="premium-input-box p-16 border radius-8 bg-light-soft">
                            <label
                                class="text-xs fw-bold text-uppercase tracking-wider text-primary-light mb-8 d-block">
                                <i class="ri-barcode-line me-1"></i> Custom Barcode Graphic / Asset Upload
                            </label>
                            <div class="inner-addon">
                                <input type="file" id="cfgBarcodeGraphicUpload" class="form-control"
                                    accept="image/*" style="font-size: 0.8rem; padding: 6px;">
                            </div>
                            <small class="text-muted text-xxs d-block mt-4">Upload a high-resolution explicit barcode
                                graphic token. Replaces default system font vector engine style.</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="row gy-4">
                    <div class="col-xl-6 col-12">
                        <div class="p-16 border bg-light-soft radius-8">
                            <span class="text-xs fw-bold text-dark-main mb-12 d-block"><i
                                    class="ri-font-color me-1 text-primary"></i> Institution Header Font Metrics</span>
                            <div class="row g-2">
                                <div class="col-6">
                                    <input type="number" id="fontInstSize" class="form-control form-control-sm"
                                        placeholder="Size (px)" value="12" title="Font Size">
                                </div>
                                <div class="col-6">
                            ...
                            <div class="row g-2">
                                <div class="col-6">
                                    <input type="number" id="fontMemberSize" class="form-control form-control-sm"
                                        placeholder="Size (px)" value="15" title="Font Size">
                                </div>
                                <div class="col-6">
                            ...
                            <div class="row g-2">
                                <div class="col-6">
                                    <input type="number" id="fontMetaSize" class="form-control form-control-sm"
                                        placeholder="Size (px)" value="11" title="Font Size">
                                </div>
                                <div class="col-6">
                    ...
                    <div class="col-xl-6 col-12">
                        <div
                            class="p-16 border bg-light-soft radius-8 h-100 d-flex flex-column justify-content-center">
                            <label
...
@push('styles')
    <style>
        ...
        /* PERFECT ENFORCED VERTICAL PVC ID CARD CR80 RATIO STRUCT */
        ...
        /* CRITICAL HIGH-PRECISION HARDWARE PRINT TUNING LAYER */
        @media print {
            body * {
                visibility: hidden;
            }

            /* Sirf hamare card stack container ko print zone me render karega */
            .print-preview-wrapper-zone,
            .print-preview-wrapper-zone * {
                visibility: visible;
            }

            .unique-print-no-render,
            #resetCanvasCustomizer,
            #dispatchPrintQueue,
            .card-header,
            .badge {
        ...
        $(document).ready(function() {
            ...
            $('#activeMemberSelector').on('change', function() {
                ...
                if ($(this).val() !== "") {
                    ...
                    $('#canvasMemberClass').text(option.data('class') + " | Roll: #" + option.data('roll'));
                    ...
                    $('#canvasMemberPhoto').addClass('d-none');
            ...
            // CUSTOM BARCODE UPLOAD INTERACTION ANCHOR
            ...
            // Typography configurations mapping
            ...
            $('#resetCanvasCustomizer').on('click', function() {
                ...
                $('#canvasHeaderTitle').text('EXCELLENCE PUBLIC SCHOOL').css('font-size', '12px');
                $('#canvasHeaderSubtitle').text('Digital Central Library Pass');
