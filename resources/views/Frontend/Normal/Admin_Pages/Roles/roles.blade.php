...
@section('title', 'KTR ERP : Roles Manage')
...
@section('dynamic-content')
    ...
    <div class="dashboard-main-body">
        ...
        <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            ...
            <button type="button" class="my-sidebar-btn btn btn-primary-600 d-flex align-items-center gap-6 add role">
        ...
        <div class="mt-24">
            <div class="card h-100">
                <div class="card-body p-0 dataTable-wrapper">
                    ...
                    <div class="p-3">
                        <table class="table bordered-table mb-0 data-table" id="RoleDataTable" data-page-length='10'>
                            <thead>
                                <tr>
